...
title: Overview
---
![Logging Logo](https://github.com/gardener/logging/raw/master/images/logo/logging.png)
...
```
A full [example configuration file](https://github.com/gardener/logging/blob/master/example.config) is also available in this repository.
