...
Gardener creates Extension resources as part of the Shoot reconciliation. Moreover, it is guaranteed that the [Cluster](/extensions/cluster) resource exists before the `Extension` resource is created.
