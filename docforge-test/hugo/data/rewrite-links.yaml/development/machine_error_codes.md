...
All provider API calls defined in this spec MUST return a [machine error status](https://github.com/pkg/util/provider/machinecodes/codes/codes.go), which is very similar to [standard machine status](https://github.com/grpc/grpc/blob/master/src/proto/grpc/status/status.proto).
