...
<tr>
    <td>        
        <img alt="Enabling Kubernetes in Docker image" src="https://github.com/gardener/documentation/blob/master/website/blog/2018_week_06/blog-kubernetes-enable.png" title="Enabling Kubernetes in Docker image"/>
    </td>
    <td valign="top">
        <div>
