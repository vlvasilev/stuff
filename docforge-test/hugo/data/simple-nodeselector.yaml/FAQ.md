...
* Stateful applications (with PVCs) are serially evicted. Please find more info in this [answer below](https://github.com/gardener/machine-controller-manager/blob/master/docs/How-are-the-stateful-applications-drained-during-machine-deletion?).
